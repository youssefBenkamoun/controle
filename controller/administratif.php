...
if (isset($_GET['id'])) {
    ...
    $filepath = 'uploads/' . $file['dossier_administratif'];
echo $file['dossier_administratif']; 
    if (file_exists($filepath)) {
        ...
        header('Content-Length: ' . filesize('uploads/' . $file['dossier_administratif']));
        readfile('uploads/' . $file['dossier_administratif']);
        /*
