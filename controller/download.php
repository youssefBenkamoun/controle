...
if (isset($_GET['id'])) {
    ...
    $filepath = 'uploads/' . $file['dossier_pedagogique'];
echo $file['dossier_pedagogique']; 
    if (file_exists($filepath)) {
        ...
        header('Content-Length: ' . filesize('uploads/' . $file['dossier_pedagogique']));
        readfile('uploads/' . $file['dossier_pedagogique']);
        /*
